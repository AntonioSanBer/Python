...
class interface_write_save:
    ...
    def agregar_menu(self):
        ...
        opciones1.add_command(label="Guardar como", command=self.guardar)
    ...
    def guardar(self):
        ...
        if nombrearch!='':
            ...
            archi1.close()
            mb.showinfo("Información", "Se ha guardado correctamente.")
